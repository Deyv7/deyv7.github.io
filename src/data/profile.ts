...
export const experience: Job[] = [
  {
    ...
    points: [
      'Co-fundei o estúdio e construí o site institucional do zero: identidade, textos e código em Next.js 16, TypeScript e Tailwind',
  ...
  {
    period: '2024 — atual',
    title: 'Fundador e Desenvolvedor (Dados e Produto)',
    org: 'E-Habilita',
    place: 'remoto',
